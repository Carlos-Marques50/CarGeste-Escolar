                    ...
                    <div class="panel-body">
                        <form action="#" id="loginForm">
                            ...
                            <div class="form-group">
                                <label class="control-label" for="username">Email / Número de estudante</label>
                                <input type="text" placeholder="example@gmail.com / 5240" required="" title="por favor entra com o seu email ou número de aluno" name="AccessDate" id="username" class="form-control">
                                <span class="help-block small">Seu email exclusivo para o aplicativo ou número de aluno</span>
                            </div>
                            <div class="form-group">
